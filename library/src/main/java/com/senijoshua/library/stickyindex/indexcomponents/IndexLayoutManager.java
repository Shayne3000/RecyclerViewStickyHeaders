...
public class IndexLayoutManager implements Subscriber {
    ...
    public void update(RecyclerView referenceList, float dx, float dy) {
        if (indexList != null) {
            ...
            TextView firstRowIndex = (TextView) firstVisibleView.findViewById(R.id.sticky_row_details_tv_row_index);
            TextView secondRowIndex = (TextView) secondVisibleView.findViewById(R.id.sticky_row_details_tv_row_index);
